...
public class GLog {
	...
	private static final String LOG_TAG = "FinanceQuotes";
	private static GLog glog;
	...
	public static void e(Throwable ex) {
		...
		if (DEBUG.DEVELOP_MODE) {
			...
			Log.println(Log.ERROR, LOG_TAG, String.format("[%s][%s][%s]%s", ste.getFileName(), ste.getMethodName(), ste.getLineNumber(), log));
		}
	}
